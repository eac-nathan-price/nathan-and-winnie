...
export class Voronoi {
  ...
  reset() {
    if (!this.beachline) this.beachline = new RBTree();
    ...
    if (!this.circleEvents) this.circleEvents = new RBTree();
  ...
  equalWithEpsilon = (a: number, b: number) => this.abs(a-b)<EPSILON;
  greaterThanWithEpsilon = (a: number, b: number) => a-b>EPSILON;
  greaterThanOrEqualWithEpsilon = (a: number, b: number) => b-a<EPSILON;
  lessThanWithEpsilon = (a: number, b: number) => b-a>EPSILON;
  lessThanOrEqualWithEpsilon = (a: number, b: number) => a-b<EPSILON;
}
